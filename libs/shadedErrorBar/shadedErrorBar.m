...
params.addParameter('lineWidth', 1, @(x) isnumeric(x));
params.addParameter('lineWidthPatch', 1, @(x) isnumeric(x));
...
linewidth_patch = params.Results.lineWidthPatch;
...
function H = makePlot(x,y,errBar,lineProps,transparent,patchSaturation, linewidth, linewidth_patch)

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % Plot to get the parameters of the line

    H.mainLine=plot(x,y, lineProps{:}, 'LineWidth', linewidth);
    ...
    edgeColor=mainLineColor+(1-mainLineColor)*0.5;
    ...
    H.edge(1)=plot(x,lE, lineProps{:},'color',edgeColor,'HandleVisibility','off', 'LineWidth', linewidth_patch);
    H.edge(2)=plot(x,uE, lineProps{:},'color',edgeColor,'HandleVisibility','off', 'LineWidth', linewidth_patch);
    
%     H.edge(1)=plot(x,lE,'-','color',edgeColor,'HandleVisibility','off', 'LineWidth', linewidth_patch);
%     H.edge(2)=plot(x,uE,'-','color',edgeColor,'HandleVisibility','off', 'LineWidth', linewidth_patch);
